...
const { getSportsLeagueFuturesDashboardPayload, notFound } = vi.hoisted(() => ({
  getSportsLeagueFuturesDashboardPayload: vi.fn(),
  notFound: vi.fn(() => {
...
vi.mock("@/features/sports/server", () => ({
  getSportsLeagueFuturesDashboardPayload,
}));

import SportsLeagueFuturesPage from "./page";

describe("SportsLeagueFuturesPage", () => {
  it("renders the curated NBA dashboard contract", async () => {
    getSportsLeagueFuturesDashboardPayload.mockResolvedValueOnce({
      league: "nba",
  ...
  it("maps unsupported leagues to notFound()", async () => {
    getSportsLeagueFuturesDashboardPayload.mockResolvedValueOnce(null);
